...
const NewForm = () => {
    ...
    const [ checkbox, setCheckbox ] = useState({
        ...
        classList: "col list-group-item form-check-label border border-primary bg-light text-danger fs-2 rounded",
    })
    ...
    const handleCheckboxChange = (event) => {
        if (event.target.checked === false) {
            setCheckbox({
                text: "Add to Favorites?",
                classList: "col list-group-item form-check-label border border-light bg-light text-danger fs-2 rounded",
            })
    ...
    return (
        <div className="Form p-5 my-5 bg-primary text-dark rounded" style={{overflowX: "scroll"}}>
            <div className="container">
                ...
                <form className="container" onSubmit={handleSubmit}>
                    ...
                    <div className="list-group list-group-horizontal form-check form-switch rounded justify-content-center">
                        <label className={checkbox.classList} id="is_favorite" >{checkbox.text}
                            <input
